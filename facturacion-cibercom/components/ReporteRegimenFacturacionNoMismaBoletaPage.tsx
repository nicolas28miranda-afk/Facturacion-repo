...
import { FaDownload, FaFilter, FaSearch, FaCalendarAlt, FaStore, FaUser, FaFileAlt, FaExclamationTriangle } from 'react-icons/fa';
...
const ReporteRegimenFacturacionNoMismaBoletaPage: React.FC = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Genera y consulta reportes de régimen de facturación con boletas diferentes
          </p>
        </div>
        ...
        <Card title="Filtros de Búsqueda" className="mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => handleFiltroChange('regimen', e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
          ...
          <div className="mt-6 flex justify-end space-x-4">
            <button
              onClick={() => setFiltros({ fechaInicio: '', fechaFin: '', tienda: '', usuario: '', regimen: '' })}
...
export default ReporteRegimenFacturacionNoMismaBoletaPage;
