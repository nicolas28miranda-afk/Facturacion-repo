...
import { FaDownload, FaFilter, FaSearch, FaCalendarAlt, FaStore, FaUser, FaFileAlt } from 'react-icons/fa';
...
const ReporteConsultaMonederosPage: React.FC = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Genera y consulta reportes de monederos electrónicos
          </p>
        </div>
        ...
        <Card title="Filtros de Búsqueda" className="mb-8">
          ...
          <div className="mt-6 flex justify-end space-x-4">
            <button
              onClick={() => setFiltros({ fechaInicio: '', fechaFin: '', tienda: '', usuario: '' })}
...
export default ReporteConsultaMonederosPage;
