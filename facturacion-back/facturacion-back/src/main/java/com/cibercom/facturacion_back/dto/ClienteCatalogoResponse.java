...
public class ClienteCatalogoResponse {
    ...
    public static ClienteCatalogoResponse notFound() {
        ClienteCatalogoResponse r = new ClienteCatalogoResponse();
        r.setEncontrado(false);
        r.setCliente(null);
        return r;
    }

    public static ClienteCatalogoResponse ok(Cliente c) {
        ClienteCatalogoResponse r = new ClienteCatalogoResponse();
        r.setEncontrado(true);
        r.setCliente(c);
        return r;
    }
